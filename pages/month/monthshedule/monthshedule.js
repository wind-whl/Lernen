...
Page({
  data: {
    hasEmptyGrid: false,
    dayHide: true,
    TaskItems1: wx.getStorageSync('tasksData1') || [],
...
//勾选checkbox，改变完成状态
  changeStatus: function (e) {
    let _this = this,
      AllDatas = _this.data.TaskItems1;//所有设置的任务
    ...
    wx.setStorageSync('tasksData1', AllDatas);
...
//解决长按删除组件
  ...
  taskDetail: function (e) {//页面跳转
    ...
    if (touchTime > 350) {
      ...
      let AllDatas = _this.data.TaskItems1;//所有设置的任务
...
//确认任务写入
  newTask: function(e){//新建任务2 设置值
    ...
    console.log(dataID)
    let AllDatas = this.data.TaskItems1;//所有设置的任务
